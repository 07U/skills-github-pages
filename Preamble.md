...
&nbsp;&nbsp;&nbsp;&nbsp;I hope this text will provide a refreshing point of view to some readers, and help others. The derivations are also not rigorous, as I hope the small details skipped are easily reproducible by the reader, and because I wanted to release the text at some point. With that said, this is the internet - if something is missing, or some jump is too big, please write to me and I will make sure the text gets improved and things get clarified. Although most of the information here is not new, in the last section of this text, a new algorith, is presented. I am not aware of a similar algorithm, and I hope it could be helpful, even if just on the conceptual level, for other developers.
<br><br>
