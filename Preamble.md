...
&nbsp;&nbsp;&nbsp;&nbsp;Okay, but why is it presented here? Well, I wanted to "publish" it somewhere, and the concepts that are going to be reviewed are well known in the scientific community. However, in a practical industry like the video games one, some of the concepts covered here may not be familiar to some. I would have liked to allow for a potential discussion about the text, and a social media as LinkedIn looks like a good platform to have one with other professionals. Unfortunately, LinkedIn is is not a friendly platform for technical articles, so I had to drop the idea of pablishing the text there. So we ended up with this hybrid model - GitHub is responsible on presenting the text, while the discussion is done in dedicated posts on LinkedIn. This would also allow this text to get more exposure.
<br><br>
